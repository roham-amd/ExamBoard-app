...
type ReadableSearchParams = URLSearchParams | Record<string, string | string[] | undefined>
...
const getFirstValue = (params: ReadableSearchParams, key: string): string | null => {
  if (isUrlSearchParams(params)) {
...
export const parseTimetableFilters = (params: ReadableSearchParams): TimetableFilters => {
...
export const createTimetableQuery = (filters: TimetableFilters): URLSearchParams => {
