...
const normaliseHolidayPayload = (values: HolidayFormValues) => ({
  ...values,
  description: values.description ? values.description.trim() || undefined : undefined,
...
export default function HolidaysPage() {
  ...
  const onSubmit = form.handleSubmit(async values => {
    ...
    try {
      if (dialogMode === 'edit' && selectedHoliday) {
        await updateMutation.mutateAsync({ id: selectedHoliday.id, data: payload })
  ...
  const columns: DataTableColumn<Holiday>[] = [
    ...
    { header: t('columns.room'), accessor: item => item.room_name ?? t('allRooms') },
            ...
            <div className="grid gap-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  disabled={isSubmitting}
                />
                <label className="text-sm text-foreground" htmlFor="holiday-global">
                  {t('allRooms')}
                </label>
              </div>
              <Controller
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label className="text-sm text-foreground" htmlFor="holiday-all-day">
                  {t('form.allDay')}
                </label>
              </div>
              <Controller
